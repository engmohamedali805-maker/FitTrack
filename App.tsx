...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // رسالة تحفيزية تظهر في أول زيارة للجلسة
    if (!sessionStorage.getItem('welcome_shown')) {
      setMessages([{
        id: 'init',
        role: 'model',
        text: 'أهلاً بك يا بطل في طريقك نحو النسخة الأفضل من نفسك! ✨\n\nتذكر أن الالتزام هو الفرق بين الحلم والواقع. كل سعرة تسجلها وكل تمرين تنجزه يقربك خطوة من هدفك. أنا هنا لأدعمك بكل خطوة، لنراقب تقدمك معاً ونحقق المستحيل.\n\nابدأ الآن بتصوير وجبتك أو تسجيل تمرينك.. الانضباط يبدأ من هذه اللحظة! 🚀'
      }]);
      sessionStorage.setItem('welcome_shown', 'true');
    }
  }, []);

  // الحفظ المحلي والمزامنة السحابية
  useEffect(() => {
